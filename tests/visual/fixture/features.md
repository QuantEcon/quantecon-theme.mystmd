...
site:
  ...
  # A declared per-page option on the same page. Undeclared, it would replace
  # the page's `site:` block and silently drop the override above.
  hide_search: false
---
